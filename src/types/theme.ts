...
// =============================================================================
// Theme Prompt Suggestion Types (ADR-002)
// =============================================================================

/**
 * Represents a creative theme prompt suggestion for user inspiration.
 * Can be generated by AI or curated from proven examples.
 */
export interface ThemePromptSuggestion {
...
/**
 * Result of theme prompt suggestion generation.
 * Success contains suggestions array, failure contains actionable error information.
 */
export type ThemePromptSuggestionResult = 
    | { readonly success: true; readonly suggestions: readonly ThemePromptSuggestion[] }
    | { readonly success: false; readonly error: ThemeApplicationError };
