...
export async function applyThemeCustomizations(
    ...
    const newCustomizations = {
        ...
        "statusBarItem.prominentHoverBackground": adjustColor(colors.accent, 1.1),
        "statusBarItem.hoverBackground": adjustColor(colors.accent, 1.1),
        "statusBarItem.activeBackground": adjustColor(colors.accent, 0.95),
        "statusBarItem.focusBorder": colors.accent,
        "statusBarItem.errorBackground": "#ff6347",
        "statusBarItem.errorForeground": "#ffffff",
        "statusBarItem.warningBackground": adjustColor(colors.accent, 0.9),
        "statusBarItem.warningForeground": getContrastColor(adjustColor(colors.accent, 0.9)),
        "statusBarItem.remoteBackground": colors.primary,
        "statusBarItem.remoteForeground": getContrastColor(colors.primary),
        // Editor
